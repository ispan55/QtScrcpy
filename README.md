...
Вы можете написать свой скрипт для сопоставления действий клавиатуры и мыши с прикосновениями и щелчками мобильного телефона в соответствии с вашими потребностями. [Здесь](docs/KeyMapDes.md) правила написания сценария.
